        ...
        <form>
            ...
            <div class="row box1 mb-2">
                <div class="col-12 text-center pt-5">
                    ...
                    <h3 class="px-5">DE TU PROXIMA <span class="accentColor">TOCATA O CONCIERTO</span> QUE DESEAS
                        ASISTIR
                        Y CONOCE <span class="accentColor">NUEVOS AMIGOS #FANS</span> PARA IR A VER Y ESCUCHAR MUSICA EN
                        VIVO </h3>
                </div>
