                ...
                <div class="col mr-2">
                    <div class="row box1 mb-2 py-4">
                        <div class="col text-center">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="number" class="form-control" name="members" placeholder="2" value="">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="inputState">Region</label>
                                    <input type="text" class="form-control" name="region" placeholder="metropolis" value="">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputState">Ciudad</label>
                                    <input type="text" class="form-control" name="city" placeholder="Santiago" value="">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputState">Pais</label>
                                    <input type="text" class="form-control" name="country" placeholder="Chile" value="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row box1 mb-2 py-4">
                        ...
                        <div class="col-sm-4 text-center">
                            <div class="form-row">
                                <div class="col-sm-4">
                                    <input type="number" class="form-control form-control-sm" name="songs_number" value="" placeholder="2">
                                </div>
                                <label for="Miembros" class="col-sm-auto col-form-label">Canciones</label>
                            </div>
                            <div class="form-row">
                                <div class="col-sm-4">
                                    <input type="number" class="form-control form-control-sm" name="eps" placeholder="2" value="">
                                </div>
                                <label for="Miembros" class="col-sm-auto col-form-label">EPS</label>
                            </div>
                            <div class="form-row">
                                <div class="col-sm-4">
                                    <input type="number" class="form-control form-control-sm" name="discs" value="" placeholder="2">
                                </div>
                        ...
                        <div class="col-sm-8 text-center">
                            <div class="form-row">
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-sm" id="facebook"  value="" placeholder="2">
                                </div>
                                <label for="Miembros" class="col-sm-auto col-form-label">Facebook</label>
                            </div>
                            <div class="form-row">
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-sm" id="instagram" value="" placeholder="2">
                                </div>
                                <label for="Miembros" class="col-sm-auto col-form-label">Instagram</label>
                            </div>
                            <div class="form-row">
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-sm" id="youtube" value="" placeholder="2">
                                </div>
                                <label for="Miembros" class="col-sm-auto col-form-label">Youtube</label>
                            </div>
                            <div class="form-row">
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-sm" id="concert" value="" placeholder="2">
                                </div>
                    ...
                    <div class="row box1 mb-2 py-4">
                        ...
                        <div class="col-12 text-center">
                            ...
                            <div class="form-group row">
                                <div class="form-group col-sm">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="amplification" value="1">
                                        <label class="form-check-label" for="Solista"><h2>SI</h2></label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="amplification" value="0" >
                                        <label class="form-check-label" for="Grupo"><h2>NO</h2></label>
                                    </div>
                                </div>
                            </div>
