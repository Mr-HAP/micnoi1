...
<div id="app" class="container">
    ...
    <div class="nav justify-content-end">
        <nav>
            <!-- Authentication Links -->
            @guest
                <a class="btn btn-xl accentColor" href="{{ route('login') }}" data-toggle="modal"
                   data-target="#loginModal" data-whatever="@mdo">{{ __('Login') }}</a>
            ...
            @else
                ...
                <div class="dropdown-menu dropdown-menu-top" aria-labelledby="dropdownMenuOffset">
                    ...
                    <a class="dropdown-item" href="#">My Bands/Musicxs</a>
                </div>
